...
const StickSection = () => {
  // const stickyData = [
  //   { id: 1, title: "liga f", src: "/work/images/1.jpg" },
  //   { id: 2, title: "seve collection", src: "/work/images/2.jpg" },
  //   { id: 3, title: "starvie", src: "/work/images/3.jpg" },
  // ]

const stickyData = [
  { id: 1, title: "liga f", src: `${base}work/images/1.jpg` },
  { id: 2, title: "seve collection", src: `${base}work/images/2.jpg` },
  { id: 3, title: "starvie", src: `${base}work/images/3.jpg` },
];
  ...
  return (
    ...
    <div className="row flex-column flex-md-row align-items-center justify-content-md-center gap-4 px-4 mb-5">
      ...
      <div className="col col-sm-7 col-md-4 p-3">
        {/* <img className="uts-fluid rounded-2" src="/home/x.jpg" alt="img" loading="lazy" /> */}
        <img className="uts-fluid rounded-2" src={`${base}home/x.jpg`}  alt="img" loading="lazy" />
      </div>
